        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <fieldset className="fieldset">
                    ...
                    <input {...register("title", { required: true })} type="text" required className="input w-full" placeholder="Enter a title for your question" />
                </fieldset>
                ...
                <fieldset className="fieldset">
                    ...
                    <textarea {...register("body", { required: true })} required className="textarea min-h-60 w-full row-span-12" placeholder="Enter a body for your question"></textarea>
                </fieldset>
                <fieldset className="fieldset">
                    ...
                    <select {...register("tag", { require: true })} defaultValue="default" required className="select select-md w-full">
