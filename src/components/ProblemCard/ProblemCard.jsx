...
const ProblemCard = ({ problem, isLocked = false }) => {
    ...
    if (isLocked) {
      return (
        <div className="relative cursor-not-allowed">
          {children}
          <div className="absolute border inset-0  backdrop-blur-sm rounded-2xl flex items-center justify-center">
  ...
  return (
    <CardWrapper>
      <div className="bg-transparent shadow-md rounded-2xl my-3 p-5 hover:shadow-lg transition-all border border-gray-100">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <Code className="text-pink-500" size={22} />
        ...
        <p className="text-purple-600 text-sm leading-relaxed line-clamp-2">{description}</p>
      </div>
    </CardWrapper>
  );
};
