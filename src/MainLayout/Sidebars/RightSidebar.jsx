    ...
    <div className="hidden lg:block p-4">
      <div className="space-y-4">
        ...
        <div className="border border-gray-300 rounded-xl shadow-md p-5">
          <h3 className="text-lg font-semibold dark:text-blue-500">
            The Discuss Blog
          </h3>
    ...
    return (
        <div className="hidden lg:block p-4">
            <div className="space-y-4">
                ...
                {/* The Discuss Blog Section */}
                <div className="bg-white  border border-gray-300 rounded-xl shadow-md p-5">
                ...
                <div className="bg-white  border border-gray-300 rounded-xl shadow-md p-5">
                    ...
                    <ul className="mt-2 space-y-2">
                        <li className="flex items-center gap-2 hover:text-blue-500 cursor-pointer">
                            <FiMessageSquare /> How might Chat evolve? Help us identify problems and opportunities
                        </li>
                        <li className="flex items-center gap-2 hover:text-blue-500 cursor-pointer">
                            <FiMessageSquare /> Community Asks Sprint Announcement - March 2025
                        </li>
                        <li className="flex items-center gap-2 hover:text-blue-500 cursor-pointer">
                            <FiMessageSquare /> Policy: Generative AI (e.g., ChatGPT) is banned
                        </li>
                        <li className="flex items-center gap-2 hover:text-blue-500 cursor-pointer">
                            <FiMessageSquare /> Is it better to redirect users who attempt to perform actions they can't yet...
                        </li>
                    </ul>
                </div>

                {/* Hot Meta Posts Section */}
                <div className="bg-white  border-gray-300  rounded-xl shadow-md p-5">
                    ...
                    <p className="mt-2  dark:text-gray-300 hover:text-blue-500 cursor-pointer flex items-center gap-2">
                        <FiMessageSquare /> Just how perfect does a question have to be to leave SG?
                    </p>
                </div>
                        ...
                        {[...Array(5)].map((_, i) => (
                            <li key={i} className="border-b pb-3 last:border-none">
                                <p className="hover:text-blue-500 cursor-pointer">
                                    Why does TypeScript infer an intersection type (&) instead of a union (|)?
                                </p>
                                <div className="flex justify-between text-sm mt-1">
                                    ...
                                    <p className="text-blue-500 hover:underline cursor-pointer">+ Follow</p>
                                </div>
                            </li>
                        ))}
                    </ul>
...
>>>>>>> 65e4790369b350cf9766cfc9bf24e1d4ecab34c5
        ...
        {/* Featured on Meta Section */}
        <div className=" dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl shadow-md p-5">
          <h3 className="text-lg font-semibold text-white ">
            Featured on Meta
          </h3>
          <ul className="mt-2 space-y-2 text-gray-700 dark:text-gray-300">
            <li className="flex items-center gap-2 hover:text-blue-500 dark:hover:text-blue-400 cursor-pointer">
        ...
        {/* Hot Meta Posts Section */}
        <div className=" dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl shadow-md p-5">
          <h3 className="text-lg font-semibold text-white">Hot Meta Posts</h3>
          <p className="mt-2 text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 cursor-pointer flex items-center gap-2">
        ...
        <div className=" dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl shadow-md p-5">
          ...
          <ul className="mt-2 space-y-4 text-gray-700 dark:text-gray-300">
            {[...Array(5)].map((_, i) => (
              <li
                key={i}
                className="border-b pb-3 last:border-none border-gray-300 dark:border-gray-700"
              >
                <p className="hover:text-blue-500 dark:hover:text-blue-400 cursor-pointer">
                ...
                <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400 mt-1">
                  ...
                  <p className="text-blue-500 dark:text-blue-400 hover:underline cursor-pointer">
                    + Follow
                  </p>
                </div>
              </li>
