...
// const Login = () => {
//   const { loginUser, signInWithGoogle, createUserGithub, resetPassword } = useContext(AuthContext);
//   const navigate = useNavigate();
...
//       console.log("✅ Google login successful. User Email:", result.user.email); // Now this should NOT be null
...
//     createUserGithub()
//       .then(result => {
//         console.log("✅ GitHub login successful. User Email:", result.user.email);
//         Swal.fire({
//           title: "Success!",
...
//     loginUser(email, password)
//       .then(result => {
//         console.log("✅ Email login successful. User Email:", result.user.email);
//         Swal.fire({
//           title: "Success!",
...
//         <div className="hero-content flex-col lg:flex-row-reverse">
//           <div className="text-center lg:text-left lg:w-96">
//             <Lottie animationData={register_lottie} loop={true} autoplay={true} />
//           </div>
//           <div className="card bg-base-100 w-full max-w-sm shrink-0">
//             <h1 className="text-5xl font-bold mt-4 text-center">Login now!</h1>
//             <form className="card-body" onSubmit={handleLogin}>
...
//                 />
//                 <label onClick={handleForgotPass} className="label">
//                   <span className="label-text-alt link link-hover cursor-pointer">Forgot password?</span>
//                 </label>
//               </div>
...
//                   <Link to="/registration" className="text-blue-500 font-bold"> Go to Registration</Link>
//                 </p>
//                 <p className="text-center text-lg font-bold mt-2">Or sign up with</p>
//               </div>
...
//               <div className="flex justify-center gap-4 mt-5">
//                 <Link onClick={handleGoogleSignup}><FcGoogle className="text-5xl" /></Link>
//                 <Link><FaFacebook className="text-5xl text-blue-600 opacity-50 cursor-not-allowed" /></Link>
//                 <Link onClick={handleGithubSignup}><FaGithub className="text-5xl text-black" /></Link>
//               </div>
//             </form>
//           </div>
