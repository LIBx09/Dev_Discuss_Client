...
const Users = () => {
  ...
  return (
    <div className=" max-w-4xl mx-auto ">
      <h2 className="text-2xl font-bold mb-8 text-center">Active Users</h2>
      {users?.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {users?.map((user) => (
            <div
              key={user._id}
              className="  p-6 rounded-xl border-t-8 border-t-blue-500 shadow-lg hover:scale-110  hover:shadow-blue-300 transition-all duration-300 flex flex-col items-center text-center max-w-sm w-full"
            >
              ...
              <p className="text-sm text-gray-500 mb-2 dark:text-gray-300">{user?.userEmail}</p>
