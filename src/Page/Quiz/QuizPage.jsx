  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-8 px-4">
      <div className="w-full max-w-3xl bg-transparent rounded-xl shadow-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-br from-[#5847f1] via-[#3a28f8] to-[#0909fc] shadow-2xl overflow-hidden text-white p-6 ">
        ...
        {!quizCompleted ? (
          <div className="p-6">
            ...
            <motion.div 
              ...
              className="mb-6"
            >
              <h2 className="text-xl text-blue-400 font-semibold mb-4">{currentQuestion.question}</h2>
            ...
            {showExplanation && (
              ...
              >
                ...
                <p className="mt-2 text-blue-700">{currentQuestion.explanation}</p>
              </motion.div>
            )}
            ...
            {answerStatus !== null && (
              <div className="mt-6">
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-500 rounded-lg text-lg font-semibold text-white hover:scale-105 transition-transform duration-300 shadow-xl"
                >
