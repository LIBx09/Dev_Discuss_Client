...
export const fetchQuestions = createAsyncThunk(
  "questions/fetchAll",
  async () => {
    const res = await axios.get("https://dev-discuss-server-kappa.vercel.app/questions");
    return res.data;
  }
);
...
export const fetchQuestionsByTag = createAsyncThunk(
  ...
  async (tag) => {
    const res = await axios.get(`https://dev-discuss-server-kappa.vercel.app/questions/tag/${tag}`);
    return res.data;
  }
);
...
export const addQuestion = createAsyncThunk(
  ...
  async ({ data, user }, { rejectWithValue }) => {
    try {
      const res = await axios.post("https://dev-discuss-server-kappa.vercel.app/questions", {
        ...data,
